...
var HeroText = function HeroText() {
  return react__WEBPACK_IMPORTED_MODULE_0__["createElement"](HeroTextWrapper, {
    ...
    __self: this
  }, " We\u2019re passionate about crafting digital experiences and tools that both excite and empower the user "));
};
...
})(["font-size:var(--font-size-l);text-align:center;max-width:95%;margin-top:60px;margin-bottom:60px;"]);
...
})(["font-size:var(--font-size-xl);font-weight:bold;text-align:center;"]);
/* harmony default export */ __webpack_exports__["default"] = (HeroText);

/***/ })

})
//# sourceMappingURL=index.js.77dbbb0ad8f716e0a2cf.hot-update.js.map